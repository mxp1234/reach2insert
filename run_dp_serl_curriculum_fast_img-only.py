...
Terminal 1 (Learner):
    ...
    python run_dp_serl_curriculum_fast_img-only.py --learner --exp_name=peg_in_hole_square_III

Terminal 2 (Actor):
    export XLA_PYTHON_CLIENT_PREALLOCATE=false
    export XLA_PYTHON_CLIENT_MEM_FRACTION=.2
    python run_dp_serl_curriculum_fast_img-only.py --actor --exp_name=peg_in_hole_square_III --ip=localhost
